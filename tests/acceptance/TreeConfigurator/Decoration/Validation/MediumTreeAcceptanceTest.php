 ...
 */
class MediumTreeAcceptanceTest extends TestCase
{
    /**
     * @group MediumTree\RowFeatureCount
     * @group MediumTree\FeatureRepeatLimit
     * @group MediumTree\RowOnlyNestedFeatureSymbols
     * @group MediumTree\BuiltTree
     * @group MediumTree\UnknownPossibilities
     */
    ...
    {
        $builtTree = $builtTreeProvider->get('tree:medium');
    ...
    {
        self::assertCount(5, $builtTree->getRows());
    ...
    public function testOnlyNestedFeatureSymbols(BuiltTreeInterface $builtTree): BuiltTreeInterface
    {
        ...
        foreach (['row0', 'row1', 'row2', 'row3', 'row4'] as $rowId) {
